<template>
        <div class="w-full relative h-full py-5 px-2 flex flex-col sm:flex-row items-center justify-center bg-primary dark:bg-dark-primary">
            <div class="absolute top-0 left-0 bg-white dark:bg-dark-secondary header w-full justify-between items-center flex sm:px-3 px-4 py-2 sm:py-4">
...
// Create the chart
    ...
    created(){
        console.log(localStorage.theme === 'dark'||localStorage.theme !== undefined);
